...
func TestList(t *testing.T) {
	// Skip this test since it requires the OCI SDK
	t.Skip("Skipping test for FetchPaginatedInstances since it requires the OCI SDK")

	// This is a placeholder test that would normally test the FetchPaginatedInstances function
	// In a real test, we would:
	// 1. Create a mock service with mock clients
	// 2. Call FetchPaginatedInstances with different parameters
