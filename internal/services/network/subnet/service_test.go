...
func (m *mockSubnetRepository) GetSubnet(ctx context.Context, ocid string) (*domain.Subnet, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func (m *mockSubnetRepository) ListSubnets(ctx context.Context, compartmentID string) ([]domain.Subnet, error) {
	if m.err != nil {
		return nil, m.err
	}
