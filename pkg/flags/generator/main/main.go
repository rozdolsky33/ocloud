...
// It extracts flag constants from the flags package and updates the README.md file.
package main
...
import (
	...
	"github.com/rozdolsky33/ocloud/pkg/flags/generator"
)
...
func main() {
	...
	flagsDir := filepath.Join(projectRoot, "pkg", "flags")
	flagInfos, err := generator.ExtractFlagConstants(flagsDir)
	if err != nil {
