...
// ExtractFlagConstants extracts flag constants from the flags package.
func ExtractFlagConstants(flagsDir string) (map[string][]FlagInfo, error) {
	// Parse the flags.go file
	fset := token.NewFileSet()
	flagsFile := filepath.Join(flagsDir, "flags.go")
